...
<body class="bg-[#f6f7fb] font-inter">

<!-- HEADER -->
<nav id="mainHeader" 
     class="emag-gradient text-white shadow-md fixed top-0 left-0 right-0 z-50 
            transition-all duration-300 ease-in-out h-16 flex items-center">
...
<!-- Spacer ca să nu fie acoperit contentul -->
<div class="h-16"></div>
...
<footer class="text-center text-gray-600 text-sm py-10">
...
<!-- ============================================================ -->
<!--          JS: FAVORITE BUTTON GLOBAL (HEADER)                -->
<!-- ============================================================ -->
<script>
...
<!-- ============================================================ -->
<!--        JS: SHRINK HEADER + LOGO + BUTOANE LA SCROLL         -->
<!-- ============================================================ -->
<script>
...
<!-- ============================================================ -->
<!--        CSS: DIMENSIUNI MICȘORATE ÎN MOD RESPONSIV            -->
<!-- ============================================================ -->
<style>
.header-small {
