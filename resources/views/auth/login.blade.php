            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <x-text-input id="email" 
                                  class="block mt-1 w-full dark:bg-gray-900 dark:text-gray-100 dark:border-gray-600 dark:focus:border-indigo-500 dark:focus:ring-indigo-500" 
                                  type="email" 
                                  name="email" 
                                  :value="old('email')" 
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" 
                               class="rounded border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800" 
                               name="remember">
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <x-primary-button class="ml-3 dark:bg-indigo-600 dark:hover:bg-indigo-500 dark:text-white"> 
                        {{ __('Log in') }}
                    </x-primary-button>
                </div>
            </form>
